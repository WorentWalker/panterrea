...
<head>
    ...
    <title><?php echo esc_html__('Верифікація пошти', 'panterrea_v1'); ?></title>
</head>
    ...
    <div class="email-container"
        ...
        <div class="email-content">
            <h1 style="color: #272727; font-size: 18px; font-weight: 700; line-height: 28px; margin-bottom: 4px;">
                <?php echo esc_html__('Вітаємо ', 'panterrea_v1') . htmlspecialchars($display_name) ?></h1>
            <p
                style="color: #637381; font-size: 16px; font-weight: 400; line-height: 24px; margin: 0 auto 42px; max-width: 597px">
                <?php echo esc_html__('Ви успішно пройшли реєстрацію. Для верифікації вашої електронної пошти натисніть на "Верифікувати мою електронну пошту". Посилання дійсне до повторного запрошення верифікації.', 'panterrea_v1'); ?>
            </p>
            <a href="<?= htmlspecialchars($confirmation_url) ?>" class="email-button" target="_blank"
                ...
                <?php echo esc_html__('Верифікувати мою електронну пошту', 'panterrea_v1'); ?>
            </a>
