...
<head>
    ...
    <title><?= __('Скидання паролю', 'panterrea_v1') ?></title>
</head>
...
<body style="margin: 0; padding: 60px 0; background-color: #F5F5F7;">
    <div class="email-container"
        ...
        <div class="email-content">
            ...
            <p style="color: #637381; font-size: 16px; font-weight: 400; line-height: 24px; margin: 0 auto 42px;">
                <?= __('Ми отримали запит на оновлення паролю з вашого профілю Panterrea.', 'panterrea_v1') ?><br>
                <?= __('Для оновлення паролю натисні на “Оновити пароль”', 'panterrea_v1') ?><br>
                <?= __('Якщо ви не робили таких дій то можете проігнорувати це повідомлення', 'panterrea_v1') ?><br>
                <?= __('Посилання дійсне протягом 1 години', 'panterrea_v1') ?>
            </p>
            <a href="<?= htmlspecialchars($reset_url) ?>" class="email-button" target="_blank"
                style="padding: 10px 16px; border-radius: 500px; border: 1px solid rgba(20, 117, 117, 0.48); color: #147575; font-size: 15px; font-style: normal; font-weight: 700; line-height: 26px; text-decoration: none;">
                <?= __('Оновити пароль', 'panterrea_v1') ?>
            </a>
