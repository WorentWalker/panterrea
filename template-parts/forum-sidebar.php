...
<aside class="forum__sidebar" aria-label="<?php echo esc_attr__('Фільтри форуму', 'panterrea_v1'); ?>">
    <div class="forum__sidebar__section forum__sidebar__section--cta">
        <?php if (is_user_logged_in()) : ?>
        <button type="button" class="forum__sidebar__createBtn button-large js-forumScrollToComposer">
            <?php esc_html_e('Створити допис', 'panterrea_v1'); ?>
        </button>
        <?php else : ?>
        <a href="<?php echo esc_url(URL_LOGIN); ?>" class="forum__sidebar__createBtn forum__sidebar__createBtn--link button-large">
            <?php esc_html_e('Створити допис', 'panterrea_v1'); ?>
        </a>
        <?php endif; ?>
    </div>
    ...
    <div class="forum__sidebar__section">
        ...
        <div class="forum__sidebar__search">
            ...
            <input id="searchInputForum" type="search" name="search" inputmode="search" autocomplete="off"
                ...
                class="forum__sidebar__searchInput body2"
            ...
            <button type="button" class="forum__sidebar__searchSubmit" aria-label="<?php esc_attr_e('Шукати', 'panterrea_v1'); ?>"></button>
        </div>
    </div>

    <div class="forum__sidebar__section">
        <span class="forum__sidebar__label subtitle1"><?php esc_html_e('Сортування', 'panterrea_v1'); ?></span>
        <div class="forum__sidebar__sortRadios dropdown" role="radiogroup" aria-label="<?php esc_attr_e('Сортування дописів', 'panterrea_v1'); ?>">
            <div class="dropdown__item">
                <input type="radio" name="forum_feed_sort" id="forum-sort-all" value="all" <?php checked($forum_sort, 'all'); ?>>
                <label class="subtitle2" for="forum-sort-all"><?php esc_html_e('Всі дописи', 'panterrea_v1'); ?></label>
            </div>
            <div class="dropdown__item">
                <input type="radio" name="forum_feed_sort" id="forum-sort-popular" value="popular" <?php checked($forum_sort, 'popular'); ?>>
                <label class="subtitle2" for="forum-sort-popular"><?php esc_html_e('Популярні', 'panterrea_v1'); ?></label>
            </div>
            <div class="dropdown__item">
                <input type="radio" name="forum_feed_sort" id="forum-sort-recent" value="recent" <?php checked($forum_sort, 'recent'); ?>>
                <label class="subtitle2" for="forum-sort-recent"><?php esc_html_e('Останні дописи', 'panterrea_v1'); ?></label>
            </div>
            <?php if (is_user_logged_in()) : ?>
            <div class="dropdown__item">
                <input type="radio" name="forum_feed_sort" id="forum-sort-mine" value="mine" <?php checked($forum_sort, 'mine'); ?>>
                <label class="subtitle2" for="forum-sort-mine"><?php esc_html_e('Мої дописи', 'panterrea_v1'); ?></label>
            </div>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="catalog__sidebar__checkboxes">
            <div class="catalog__sidebar__checkbox dropdown__item">
                <input type="checkbox" id="forum-cat-all" class="js-forumCategoryAll"
                    <?php checked($all_categories_selected); ?>>
            ...
            <?php foreach ($categories_visible as $term) : ?>
                ...
                $fid = 'forum-cat-' . $slug;
                ?>
            <div class="catalog__sidebar__checkbox dropdown__item" data-filter-slug="<?php echo esc_attr($slug); ?>" data-filter-section="forum_category" data-available="1">
            ...
            <button type="button" class="forum__sidebar__catsToggle body2 js-forumCatsToggle"
                ...
                data-label-hide="<?php echo esc_attr__('Сховати', 'panterrea_v1'); ?>"
                aria-expanded="false">
